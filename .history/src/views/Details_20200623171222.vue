<template>
  ...
  <div class="detail_all">
    ...
    <div class="dav">
      ...
      <van-popup v-model="show" round position="bottom" :style="{ height: '43%' }">
        <div class="popupTitle">
        <div><img :src="goodsOne.image_path" alt class="image_path" /></div>
        <div>{{goodsOne.name}}</div>
        <div>￥ {{goodsOne.present_price}}</div></div>
      </van-popup>
    </div>
  </div>
</template>
