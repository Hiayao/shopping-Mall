...
export default {
  ...
  methods: {
    ...
    confirm(value) {
      ...
      this.userInfo.year = dayjs(value).format("YYYY");
      this.userInfo.month = dayjs(value).format("MM");
      this.userInfo.day = dayjs(value).format("DD");
        console.log(this.userInfo.year)
        console.log(this.userInfo.month)
        console.log(this.userInfo.day)
    },
    save() {
      this.$dialog
        .confirm({
