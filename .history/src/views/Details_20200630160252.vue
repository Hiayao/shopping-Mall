        ...
        <van-tab>
          ...
          <div>
            <div v-for="item in comment" :key="item.id">
              <div v-if="item.anonymous === false">   <!-- 判断是否匿名 -->
              ...
              <div v-else>
                <div class="avatarAll"><img :src="item.comment_avatar" alt=""  class="avatar"/></div>
              </div>
            </div>
          </div>
        </van-tab>
...
export default {
  ...
  mounted() {
    ...
    //       if (item.cid === this.goodsId) {
    //         console.log(item.cid);
    //         this._id = item._id;
    //         //查询单条评论
    //         this.$api
    //           .evaluateOne(this.goodsId, this._id)
    //           .then(res => {
    //             console.log(res);
    //           })
    //           .catch(err => {
