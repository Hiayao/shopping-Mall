<template>
  <div class="city_check">
    <div class="top">
      <van-nav-bar title="城市列表" left-text left-arrow @click-left="onClickLeft" @search="onSearch"/>
    </div>
    <div class="recommend">
      <van-search v-model="search" shape="round" show-action placeholder="请输入搜索关键词" class="ipt" />
