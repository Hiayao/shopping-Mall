<template>
  ...
  <div>
    ...
    <div class="tip">
      <div class="sure">
        <div class="check">
          <van-checkbox v-model="checked" shape="square" checked-color="red" @click="checkAll" v-if="checked === false">全选</van-checkbox>
          <van-checkbox v-model="checked" shape="square" checked-color="red" @click="checkAll" v-if="checked === true">取消全选</van-checkbox>
        </div>
        <div class="total">
          <div>合计：</div>
          <div>请确认订单</div>
      ...
      <div class="shoplist" v-for="(item,index) in shoplist" :key="index">
        ...
        <div class="details">
          ...
          <div class="nume">
            ...
            <div class="price">
              <div class="present">￥{{item.mallPrice}}</div>
              <div>
