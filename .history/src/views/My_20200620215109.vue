<template>
  <div>
    ...
    <div class="card" v-if="this.user === null">
      <div class="img">
        <van-image round width="7rem" height="7rem" src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1666256797,972082711&fm=26&gp=0.jpg" />
      </div>
...
<!-- 已登录状态 -->
    <div class="card" v-else>
      ...
      <div>
        <van-image round width="7rem" height="7rem" src="https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=234847084,411471571&fm=26&gp=0.jpg" />
      </div>
...
<div class="orderAll">
    <div class="order">
        <div class="orderIco"><van-icon name="records" /></div>
        <div>全部订单</div>
    </div>
...
<div class="orderTwo">
    <div class="order">
        <div class="orderIco"><van-icon name="star-o" /></div>
        <div>收藏商品</div>
    </div>
    <div><van-icon name="arrow" /></div>
</div>
...
<div class="orderTwo">
    <div class="order">
        <div class="orderIco"><van-icon name="location-o" /></div>
        <div>地址管理</div>
    </div>
    <div><van-icon name="arrow" /></div>
</div>
...
<div class="orderTwo">
    <div class="order">
        <div class="orderIco"><van-icon name="browsing-history-o" /></div>
        <div>最近浏览</div>
    </div>
    <div><van-icon name="arrow" /></div>
</div>
