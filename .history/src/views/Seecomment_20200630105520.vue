<template>
  ...
  <div>
    ...
    <div class="starTime">
        <div><van-rate v-model="list.rate" allow-half void-icon="star" void-color="#eee" /></div>
    ...
    <div v-for="item in list.goods" :key="item.id">
        <div class="imgAll"><img :src="item.image_path" alt="" class="img"></div>
    </div>
  </div>
</template>
