<template>
  ...
  <div v-else>
    ...
    <!-- 从购物车购买 -->
    <van-submit-bar :price="total * 100" button-text="提交订单" v-if="this.list[1] === true" @submit="onSubmit" />
    <!-- 直接购买 -->
     <van-submit-bar :price="obj.count * obj.present_price * 100" button-text="提交订单" v-else @submit="onSubmit" />
  </div>
</template>
...
this.$api
      ...
      // 直接购买
        ...
        this.total = this.obj.count * this.obj.present_price
