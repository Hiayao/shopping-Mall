<template>
  <div>
    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh"> <!-- 下拉刷新 -->
      ...
      <!-- 首页分类推荐 -->
      <div>
        <Homesort :floor='floor1' :floorName='floorName1'></Homesort>
      </div>

      <div>
        <Homesort :floor='floor2' :floorName='floorName2'></Homesort>
      </div>

      <div>
        <Homesort :floor='floor3' :floorName='floorName3'></Homesort>
      </div>
    </van-pull-refresh>
  </div>
</template>
    ...
    this.$api
      ...
      .then(res => {
        ...
        // console.log(res.data.recommend);
         ...
         this.floorName1 = res.data.floorName
