...
export default {
  ...
  methods: {
    gotoDetails(item){
      console.log(item.this.$store.state.slides.goodsId)
      this.$router.push({path:'/details',query:{id:this.$store.state.slides.goodsId}})
    }
  },
  mounted() {
    // this.id = this.$store.state.slides.goodsId
