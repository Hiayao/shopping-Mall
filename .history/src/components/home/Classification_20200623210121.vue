    ...
    <div class="Classification">
      <div class="listAll">
        <div class="list" v-for="(item,index) in category" :key="index">
          <div>
            <img :src="item.image" alt class="img" @click="gotoSort(item)"/>
          </div>
...
export default {
  ...
  methods: {
    gotoSort(item){
      console.log(item.bxMallSubDto.mallCategoryId)
      this.$router.push({path:'/sort',query:{id:item.mallCategoryId}})
    }
  },
  mounted() {},
  watch: {},
