<template>
  ...
  <div>
    <van-tabbar v-model="active" @change="change" route>
      ...
      <van-tabbar-item icon="shopping-cart" to="/shoppingcart" :badge='cartNum' v-if="this.user !== null">购物车</van-tabbar-item>
      <van-tabbar-item icon="shopping-cart" to="/shoppingcart" v-else>购物车</van-tabbar-item>
